...
public:
    ...
    void drawHLine(int start_y, int start_x, int length, char symbol, color cs, color bg) {
        for(int i = 0; i < length; i++) {
            back_buffer[start_y][start_x + i].symbol = symbol;
            back_buffer[start_y][start_x + i].sycolor = cs;
            back_buffer[start_y][start_x + i].bgcolor = bg;
        }
    }

    void drawVLine(int start_x, int start_y, int length, char symbol, color cs, color bg) {
        for(int i = 0; i < length; i++) {
            back_buffer[start_x + i][start_y].symbol = symbol;
            back_buffer[start_x + i][start_y].sycolor = cs;
            back_buffer[start_x + i][start_y].bgcolor = bg;
        }
    }
